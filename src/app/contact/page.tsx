    ...
    <section className='bg-white py-24'>
      <div className='container mx-auto px-6'>
        <div className='text-center mb-18'>
          <h2 className='text-4xl font-extrabold text-orange-900 mb-5'>
            Get In Touch
          </h2>
          <p className='text-orange-900 text-lg'>
            We are here to help you with any inquiries. Feel free to contact us
          ...
          <div className='lg:w-1/2 bg-white p-8 rounded-lg shadow-lg mb-8 lg:mb-0'>
            ...
            <form>
              <div className='mb-4'>
                <label
                  htmlFor='name'
                  className='block text-orange-900 text-sm font-bold mb-2'
                >
                  Your Name
                </label>
                <input
          ...
          <div className='lg:w-1/2 lg:pl-16 text-center lg:text-left'>
            ...
            <div className='flex justify-center lg:justify-start space-x-4'>
              <a
                ...
                className='text-orange-900 hover:text-yellow-900 transition'
              >
