      ...
      <div className="container mx-auto text-center md:text-left">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="mb-4">
            ...
            <p>
              &quot;We are dedicated to providing you with exceptional services
              that enhance your living experience and reflect your unique
              lifestyle.&quot;
            </p>
          </div>
          <div className="mb-4">
          ...
          <div className="mb-4">
            ...
            <div className="flex justify-center md:justify-start">
              ...
              <a
                ...
                className="text-white hover:text-yellow-300 mx-2"
              >
                <FaLinkedin className="w-5 h-5" />
              </a>
              <a
                href="https://www.youtube.com/@alishbarehman1905"
                className="text-white hover:text-yellow-300 mx-2"
              >
